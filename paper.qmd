...
- ...download the 4 input files we created (see below) from [github](https://github.com/paulcbauer/Writing_a_reproducable_paper_with_quarto/) (click on ![](githubcode.png) $\Rightarrow$ **Download ZIP**). Ignore/delete the other files.
