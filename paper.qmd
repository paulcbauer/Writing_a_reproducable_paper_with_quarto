...
Quarto is an open-source, scientific and technical publishing system build on `pandoc`. Their creators from RStudio also call it [„the next generation of R Markdown“](https://quarto.org/docs/computations/r.html).   
