...
-   ...download the 3 input files we created --- `paper.qmd`, `references.bib` and `data.csv` --- from [this folder](https://drive.google.com/drive/folders/1jDPpXdX6dusXpKkXEhDGujWDGf52TaxD?usp=sharing). Ignore the other files.
...
[Download these files](https://drive.google.com/drive/folders/1jDPpXdX6dusXpKkXEhDGujWDGf52TaxD?usp=sharing) and save them into a folder. Close R/Rstudio and directly open `paper.qmd` with RStudio. Doing so assures that the working directory is set to the folder that contains `paper.qmd` and the other files.[^1]
...
Below we import an exemplary dataset (you can find `data.csv` in the [folder](https://drive.google.com/drive/folders/1jDPpXdX6dusXpKkXEhDGujWDGf52TaxD?usp=sharing) with the other files).
